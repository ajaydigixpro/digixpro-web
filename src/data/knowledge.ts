...
export const knowledgeArticles: KnowledgeArticle[] = [
  ...
  },
  {
    ...
    summary: "Why WhatsApp is not an operating system. Discover how chat-based operations create hidden bottlenecks, unindexed data, and missing role-based visibility.",
    date: "Architecture Decision",
  ...
  },
  {
    ...
    summary: "Decoupled inventory architecture case study from BuySecondHandBook. Learn how isolating OMS from inventory prevents checkout race conditions under peak traffic.",
  ...
  },
  {
    ...
    summary: "Designing multi-tenant AI systems safely. Case study on enforcing database row-level security and tenant isolation before RAG context injection.",
    date: "Production Evidence",
    publishedIsoDate: "2026-07-30",
    updatedIsoDate: "2026-08-07",
  ...
  },
  {
    ...
    summary: "Healthcare data architecture insights. Learn how decoupling PHI medical records from daily operational storage improves compliance and system scale.",
    date: "Production Evidence",
    publishedIsoDate: "2026-07-30",
    updatedIsoDate: "2026-08-07",
  ...
  },
  {
    ...
    summary: "Evaluating monolithic architecture vs microservices. Learn why modular monoliths prevent premature microservices operational tax and domain complexity.",
    date: "Architecture Decision",
    publishedIsoDate: "2026-07-30",
    updatedIsoDate: "2026-08-07",
...
Stop wasting developer velocity on unnecessary distributed systems overhead. Review the <a href="/search-automation/workflow-ai-automation" class="font-bold text-[#009E73] hover:underline">DigiXPro Workflow & AI Automation Blueprint</a> to see how clean system architecture powers automated, reliable business operations.`
  },
  {
    ...
    summary: "Understanding CRM vs ERP differences. Learn how customer relationship tracking and resource planning interact across operational system boundaries.",
...
Eliminate visual inconsistency and elevate your brand authority across every channel. Explore the <a href="/design-services/custom-business-website-design" class="font-bold text-[#009E73] hover:underline">DigiXPro Strategic Branding & Custom Website Design Blueprint</a> to establish a unified visual identity.`
...

  {
    ...
    summary: "A transparent breakdown of fractional CTO cost structures. Compare fixed monthly retainers against hourly billing and full-time executive compensation.",
    date: "Advisory Insight",
    publishedIsoDate: "2026-08-07",
    updatedIsoDate: "2026-08-07",
