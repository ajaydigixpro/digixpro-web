    ...
    <div className="min-h-screen bg-[#FAFAFA] text-[#0A0A0A] font-sans px-6 py-12 max-w-5xl mx-auto selection:bg-[#22C55E]/20">
      ...
      <div className="border-b border-neutral-200 pb-8 mb-12">
        ...
        <p className="text-lg md:text-xl text-neutral-600 font-medium leading-relaxed max-w-3xl">
          Zero-to-One digital footprint and patient acquisition system for a leading physiotherapy clinic network in Greater Noida.
        </p>
        ...
        <div className="md:col-span-2 space-y-12">
          ...
          <section>
            ...
            <div className="bg-white p-6 rounded-2xl border border-neutral-200 shadow-sm space-y-4 text-neutral-700 text-sm leading-relaxed">
              <p>
                Dr Aggarwal Physio Centre was operating with zero digital visibility in a highly competitive local healthcare market. Patients relied entirely on word-of-mouth, limiting practice growth and appointment predictability.
              </p>
              <ul className="list-disc pl-5 space-y-2 text-neutral-600">
                <li>No online booking or inquiry capture mechanism</li>
                <li>Zero local search presence for high-intent queries</li>
          ...
          <section>
            ...
            <div className="bg-white p-6 rounded-2xl border border-neutral-200 shadow-sm space-y-4 text-neutral-700 text-sm leading-relaxed">
              <p>
                DigiXPro engineered a focused digital acquisition engine combining hyper-local SEO, schema-structured medical service pages, and frictionless patient intake flows.
              </p>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white p-6 rounded-2xl border border-neutral-200 shadow-sm space-y-4 text-xs font-mono">
            ...
            <div>
              ...
              <span className="text-neutral-800 font-semibold">Healthcare / Local Practice</span>
            </div>
            <div>
              <span className="text-neutral-400 block">Deliverables:</span>
              <span className="text-neutral-800 font-semibold">Website, Local SEO, Schema Markup, Booking Flow</span>
            </div>
            <div>
