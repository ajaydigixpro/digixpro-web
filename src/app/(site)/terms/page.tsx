    ...
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-[#0A0A0A] text-[#0A0A0A] dark:text-neutral-100 font-sans px-6 py-16 max-w-3xl mx-auto transition-colors duration-200">
      ...
      <div className="prose prose-neutral max-w-none space-y-8 text-sm leading-relaxed text-neutral-700 dark:text-neutral-300">
        ...
        <section>
          ...
          <p>
            By accessing or using the website at <a href="https://www.digixpro.in" className="text-[#009E73] hover:underline font-semibold">www.digixpro.in</a> (&ldquo;Website&rdquo;), you agree to be bound by these Terms of Use (&ldquo;Terms&rdquo;) issued by DigiXPro Digital Solution (&ldquo;DigiXPro&rdquo;). These Terms are governed by the laws of India. Any disputes arising from Website use shall be subject to the jurisdiction of courts in Uttar Pradesh, India.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            For paid client web engineering and custom software engagements, <strong>the client owns 100% of the custom codebase, design tokens, and digital assets</strong> upon full completion and payment. DigiXPro Digital Solution imposes zero proprietary platform lock-in fees or ongoing software licensing taxes on custom builds.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            Advisory blueprints operate independently: clients retain complete freedom to execute recommendations internally, contract third-party agencies, or engage DigiXPro Digital Solution.
          </p>
        </section>

        <section>
          <h2 className="text-base font-bold text-black dark:text-white mb-3">4. Client Responsibilities</h2>
          <p>Clients engaging DigiXPro Digital Solution are responsible for:</p>
          <ul className="list-disc pl-5 space-y-2 mt-2">
            ...
            <li>Ensuring legal rights and copyright clearances for all logos, copy, images, and data supplied to DigiXPro Digital Solution.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            Our web applications, automation pipelines, and search strategies integrate with third-party software vendors (e.g. HubSpot, Salesforce, Notion, Cloudflare, OpenAI, Anthropic, Google). DigiXPro Digital Solution is not liable for third-party vendor service outages, API deprecations, rate limits, or vendor pricing modifications.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Workflow automations (such as n8n webhooks) are engineered with error logging and notification fail-safes. However, continuous execution requires valid third-party API credentials and stable network endpoints. DigiXPro Digital Solution is not responsible for workflow interruptions caused by unnotified third-party password/token changes or external vendor API downtime.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            The Website and its contents are provided on an &ldquo;as is&rdquo; basis. To the maximum extent permitted by applicable law, DigiXPro Digital Solution shall not be liable for indirect, incidental, or consequential damages resulting from website use or implementation of published guidance. Please review our complete <a href="/disclaimer" className="text-[#009E73] hover:underline font-semibold">Disclaimer</a> for specific service boundary details.
          </p>
        </section>

        <section>
          <h2 className="text-base font-bold text-black dark:text-white mb-3">8. Privacy &amp; Data Protection</h2>
          <p>
            Your access to and use of the Website is also subject to our <a href="/privacy-policy" className="text-[#009E73] hover:underline font-semibold">Privacy Policy</a>, which details how DigiXPro Digital Solution collects, uses, and safeguards personal data, operational telemetry, and cookie preferences (including essential cookies, Microsoft Clarity analytics, and digital advertising tags such as Meta Pixel and Google Ads).
          </p>
        </section>
