    ...
    <div className="min-h-screen bg-white pb-24 font-sans text-[#0A0A0A] selection:bg-[#16a34a]/20 transition-colors duration-200 dark:bg-[#0A0A0A] dark:text-neutral-100">
      ...
      <section className="mx-auto max-w-[1200px] px-6 pb-16" aria-labelledby="contact-paths-heading">
        ...
        <div className="grid items-start gap-6 lg:grid-cols-2">
          <article className="rounded-[24px] bg-[#0A0A0A] p-7 text-white shadow-xl shadow-black/10 md:p-9">
            ...
            <a href="https://calendly.com/shukla-ajay05/30min" target="_blank" rel="noopener noreferrer" className="mt-7 inline-flex min-h-12 w-full items-center justify-center rounded-xl bg-white px-5 text-[15px] font-extrabold text-black transition hover:bg-[#57d6af] sm:w-auto">Book a 30-minute conversation <ArrowRight className="ml-2 h-4 w-4" /></a>
            <p className="mt-4 text-[13px] text-neutral-400">Select a convenient slot. The discussion starts with your operating context.</p>
          </article>
          <section id="callback-request" className="rounded-[24px] border border-neutral-200 bg-white p-7 shadow-sm md:p-9 dark:border-neutral-800 dark:bg-neutral-900" aria-labelledby="callback-heading">
