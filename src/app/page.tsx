...
export default function HomePage() {
  return (
    ...
    <div className="min-h-screen bg-white text-[#0A0A0A] font-sans selection:bg-[#16a34a]/20">
      ...
      <section className="bg-neutral-50 border-y border-neutral-200 py-24">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-[36px] md:text-[48px] font-extrabold mb-6">Does this sound familiar?</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {[
              ...
              <div key={idx} className="bg-white p-6 rounded-2xl border border-neutral-200 flex items-start shadow-sm">
                <XCircle className="w-6 h-6 text-red-400 mr-4 shrink-0 mt-0.5" />
                <p className="text-[16px] font-medium text-neutral-800">{problem}</p>
              </div>
            ))}
          </div>

          <div className="text-center">
            <p className="text-[20px] font-bold text-black mb-6">If these sound familiar, we should talk.</p>
            <Link 
              href="/contact" 
              className="inline-flex items-center justify-center px-8 py-4 bg-white text-black border border-neutral-300 font-bold text-[16px] rounded-xl hover:border-black transition-colors"
            >
      ...
      <section className="py-24 max-w-[1200px] mx-auto px-6">
        ...
        <div className="bg-neutral-50 border border-neutral-200 rounded-[32px] p-10 md:p-16 shadow-sm overflow-hidden relative">
          <RefreshCw className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 text-neutral-200/50 -z-0" />
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 relative z-10">
            {[
              ...
              <React.Fragment key={idx}>
                <div className="bg-white border border-neutral-300 px-6 py-3 rounded-xl font-mono font-bold text-[15px] text-black shadow-sm flex items-center justify-center hover:border-[#16a34a] hover:text-[#16a34a] transition-colors cursor-default">
                  {node}
                </div>
                {idx !== arr.length - 1 && (
      ...
      <section className="py-24 border-b border-neutral-200">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            {/* Deliverables */}
            <div className="bg-neutral-50 p-10 rounded-[32px] border border-neutral-200">
              <div className="text-[12px] font-mono text-[#16a34a] font-bold uppercase tracking-widest mb-3">
                The Output
              </div>
              <h2 className="text-[32px] font-extrabold mb-8">What You Actually Get</h2>
              <p className="text-[16px] text-neutral-600 mb-8">Tangible intelligence to run your business. Every engagement may include:</p>
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-y-5 gap-x-4">
                {[
                  ...
                  <li key={i} className="flex items-start text-[14px] font-bold text-neutral-800">
            ...
            <div className="p-4 md:p-10">
              <h2 className="text-[40px] md:text-[56px] font-extrabold leading-[1.1] tracking-tight mb-6">
                Implementation is optional.<br />
                <span className="text-[#16a34a]">Good architecture is not.</span>
              </h2>
              <p className="text-[18px] text-neutral-600 mb-8">
              ...
              <Link 
                href="/how-we-work" 
                className="inline-flex items-center text-[16px] font-bold text-black border-b border-black pb-1 hover:text-[#16a34a] hover:border-[#16a34a] transition-colors"
              >
      ...
      <section className="max-w-[1200px] mx-auto px-6 py-24">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-neutral-50 border border-neutral-200 shadow-sm rounded-[24px] p-8 hover:border-black/20 transition-all">
            <h3 className="text-[20px] font-bold mb-4 text-[#16a34a]">Eliminate Waste</h3>
            <p className="text-[15px] text-neutral-600 leading-relaxed">Stop paying for duplicate software, mismatched CRMs, and wrong AI investments. We align technology with actual operational reality.</p>
          </div>
          <div className="bg-neutral-50 border border-neutral-200 shadow-sm rounded-[24px] p-8 hover:border-black/20 transition-all">
            <h3 className="text-[20px] font-bold mb-4 text-[#16a34a]">Kill Manual Work</h3>
            <p className="text-[15px] text-neutral-600 leading-relaxed">Lead handling, customer onboarding, reporting, and team workflows become automated, connected pipelines.</p>
          </div>
          <div className="bg-neutral-50 border border-neutral-200 shadow-sm rounded-[24px] p-8 hover:border-black/20 transition-all">
            <h3 className="text-[20px] font-bold mb-4 text-[#16a34a]">End Founder Dependency</h3>
            <p className="text-[15px] text-neutral-600 leading-relaxed">Design role hierarchies, internal approvals, and structured knowledge bases so the business scales without you constantly intervening.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-neutral-50 py-24 border-b border-neutral-200">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <h2 className="text-[32px] md:text-[40px] font-extrabold mb-6">Technology is never the starting point. It is the outcome of understanding the business.</h2>
            ...
            {[
              ...
              <React.Fragment key={idx}>
                <div className="flex flex-col items-center min-w-[110px] p-4 rounded-xl bg-white shadow-sm border border-neutral-200">
                  ...
                  <span className={`font-bold text-[15px] ${idx === arr.length - 1 ? 'text-[#16a34a]' : 'text-black'}`}>
                    {step.name}
                  </span>
                </div>
                {idx !== arr.length - 1 && (
      ...
      ========================================== */}
      <section className="max-w-[1200px] mx-auto px-6 py-24">
        <div className="bg-white border border-neutral-200 p-12 md:p-16 rounded-[32px] text-center shadow-lg">
          <h2 className="text-[32px] md:text-[48px] font-extrabold mb-6 leading-tight text-black">
            Ready to design your operational system?
          </h2>
          <p className="text-[18px] text-neutral-600 max-w-2xl mx-auto mb-10">
