...
export default function Footer() {
  ...
  // Hide the top CTA box on service detail pages and contact page where dedicated page CTAs exist
  const hideTopCTA = pathname?.startsWith('/services/') || pathname === '/contact';
